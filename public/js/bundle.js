...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFzYW50aGd4IiwiYSI6ImNsb2NvcmMwdjAwNXEya3J3bmlmY29wenIifQ.xG_Af2Jufx7Yh56QrGjNwg';
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */ //we are disabling eslint for this file, since we have configured only NodeJS
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You have successfully logged in');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? '/api/v1/users/updateMyPassword' // prod urls
          : '/api/v1/users/updateMe'; // prod urls
          // ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword'//dev urls
          // : 'http://127.0.0.1:3000/api/v1/users/updateMe'; //dev urls
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
//////////////////////////////////////////////////////////////////////
/* eslint-disable */
var stripe = Stripe('pk_test_51O6BrvSEvPjFJbBZW32IcLk5Pfa5XdIke6TU1MiNZD2Teg6FlUdVDHBmXqWo1SrPBz5uxo3qq9P75Ri89zvRzgkn00KGSunUIP');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)( // `http://127.0.0.1:3000/api/v1/bookings/checkout-session/${tourId}`,dev url
          "/api/v1/bookings/checkout-session/".concat(tourId) //prod url
          );
        case 3:
