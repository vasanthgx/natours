...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFzYW50aGd4IiwiYSI6ImNsbzV1MmFkajBjd2Uyc253bjNkY2NjMzkifQ.OJXD5xHH8kSCwIyjlraKhw';
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') location.reload(true); ///setting the reload(true) will ensure reload from the server and not from the browser cache.
...
if (mapBox) {
  var locations = JSON.parse(document.mapBox.dataset.locations); //shifted from mapbox.js
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append('photo', document.getElementById('photo').files[0]); //files[] is an array, since we are sending only one file, we have files[0]
